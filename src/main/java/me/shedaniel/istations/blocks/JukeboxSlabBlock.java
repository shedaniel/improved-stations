...
public class JukeboxSlabBlock extends JukeboxBlock implements IWaterLoggable {
    ...
    public JukeboxSlabBlock(Properties settings) {
        super(settings);
        this.setDefaultState(this.stateContainer.getBaseState().with(TYPE, SlabType.BOTTOM).with(WATERLOGGED, Boolean.FALSE).with(HAS_RECORD, false));
    }
