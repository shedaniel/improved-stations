...
public class JukeboxSlabBlock extends JukeboxBlock implements Waterloggable {
    ...
    public JukeboxSlabBlock(Settings settings) {
        super(settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(TYPE, SlabType.BOTTOM).with(WATERLOGGED, Boolean.FALSE).with(HAS_RECORD, false));
    }
