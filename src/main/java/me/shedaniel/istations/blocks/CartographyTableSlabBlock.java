...
public class CartographyTableSlabBlock extends CartographyTableBlock implements IWaterLoggable {
    public static final EnumProperty<SlabType> TYPE = SlabBlock.TYPE;
    protected static final VoxelShape BOTTOM_SHAPE;
    protected static final VoxelShape TOP_SHAPE;
    private static final ITextComponent TITLE = new TranslationTextComponent("container.cartography_table");
    ...
    public CartographyTableSlabBlock(Properties settings) {
        super(settings);
        this.setDefaultState(this.stateContainer.getBaseState().with(TYPE, SlabType.BOTTOM).with(WATERLOGGED, Boolean.FALSE));
    }
